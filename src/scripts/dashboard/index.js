...
const accountStatus = async () => {
  ...
  const url = `${apiserver}/charts/accountStatus`
...
const pichat = async () => {
  /* Post request body content*/
  const url = `${apiserver}/charts/pichart`
  const requestOptions = {
    method: "GET",
    headers: myHeaders,
    redirect: "follow",
...
const agentstatus = async () => {
  ...
  const url = `${apiserver}/charts/agentstatus`
  const requestOptions = {
    method: "GET",
    headers: myHeaders,
    redirect: "follow",
...
const mstEventOutput = async () => {
  ...
  const url = `${apiserver}/charts/mseventoutput`
  const requestOptions = {
    method: "GET",
    headers: myHeaders,
    redirect: "follow",
...
const tEventOutput = async () => {
  ...
  let url = `${apiserver}/charts/peventoutput`
...
const customerstatus = async () => {
  ...
  const url = `${apiserver}/charts/customerstatus`
  const requestOptions = {
    method: "GET",
    headers: myHeaders,
    redirect: "follow",
...
const balancePerformance = async () => {
  ...
  /* Post request body content*/
  const url = `${apiserver}/charts/balancePerformance`
  const requestOptions = {
    method: "GET",
    headers: myHeaders,
    redirect: "follow",
...
const agentBalancePerformance = async (mphone) => {
  ...
  let loacl_CR = []
  /* Post request body content*/
  const url = `${apiserver}/charts/agentBalancePerformance`
